...
#
# QPP_MVP.tcl: Tcl script for re-creating project 'QPP_MVP'
#
# Generated by Vivado on Sun Mar 19 16:50:26 MDT 2023
...
#
# 1. This project restoration tcl script (QPP_MVP.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "./Vivado/design_1_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/Vivado/QPP_MVP/QPP_MVP.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/HLS/qpp_2_5"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/HLS/qpp_2_5/qpp_2_5/solution1/impl/ip"]"]"\
 "[file normalize "$origin_dir/[file normalize "$origin_dir/HLS/qpp_2_5/iprepo"]"]"\
  ]
  foreach ipath $paths {
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/HLS/qpp_2_5"] [file normalize "$origin_dir/HLS/qpp_2_5/qpp_2_5/solution1/impl/ip"] [file normalize "$origin_dir/HLS/qpp_2_5/iprepo"]" $obj
...
set files [list \
 [file normalize "${origin_dir}/design_1_wrapper.dcp" ]\
]
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  # Create instance: qpp_0, and set properties
  set qpp_0 [ create_bd_cell -type ip -vlnv capstone_qpp:qpp:qpp:1.0 qpp_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins qpp_0/s_axi_control_r]
  connect_bd_intf_net -intf_net qpp_0_m_axi_gmem [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins qpp_0/m_axi_gmem]
connect_bd_intf_net -intf_net [get_bd_intf_nets qpp_0_m_axi_gmem] [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net qpp_0_m_axi_gmem0 [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins qpp_0/m_axi_gmem0]
connect_bd_intf_net -intf_net [get_bd_intf_nets qpp_0_m_axi_gmem0] [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins ila_1/SLOT_0_AXI]

  # Create port connections
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins qpp_0/ap_rst_n]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins qpp_0/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs qpp_0/s_axi_control_r/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces qpp_0/Data_m_axi_gmem] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces qpp_0/Data_m_axi_gmem0] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"1.09589",
...
preplace inst processing_system7_0 -pg 1 -lvl 5 -x 1630 -y 140 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 1 -x 130 -y 450 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 490 -y 400 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -x 1240 -y 410 -defaultsOSRD
preplace inst ila_0 -pg 1 -lvl 4 -x 1240 -y 90 -defaultsOSRD
preplace inst ila_1 -pg 1 -lvl 4 -x 1240 -y 210 -defaultsOSRD
preplace inst qpp_0 -pg 1 -lvl 3 -x 850 -y 220 -defaultsOSRD
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 3 320 260 660 310 1040
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 -50 350 310 220 640 130 1050 20 1390 250 1860
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 -50 560 NJ 560 NJ 560 NJ 560 NJ 560 1850
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1400 130n
preplace netloc processing_system7_0_DDR 1 5 1 NJ 90
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ 110
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 330 10 NJ 10 NJ 10 NJ 10 1860
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 650 200n
preplace netloc qpp_0_m_axi_gmem 1 3 1 1060 80n
preplace netloc qpp_0_m_axi_gmem0 1 3 1 1070 200n
levelinfo -pg 1 -70 130 490 850 1240 1630 1890
pagesize -pg 1 -db -bbox -sgen -70 -140 2010 1460
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/Vivado/QPP_MVP/QPP_MVP.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/QPP_MVP.srcs/utils_1/imports/synth_1/design_1_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/QPP_MVP.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/QPP_MVP.srcs/utils_1/imports/impl_1" -objects $obj
